        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoginLatitude = table.Column<double>(type: "float", nullable: false),
                    LoginLongitude = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "CreatedAt", "Email", "IsActive", "JobRole", "Mobile", "Name", "PasswordHash", "Role" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "hr@company.com", true, "HR Manager", "0000000000", "HR Admin", "$2a$11$zez6SM3KqRoWiGLFQFHLROeAnEDmRYrSBMiKoIFRFaLWFGhGOSVAy", "HR" });
